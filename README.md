...
Note that this is a work in progress where I intend to add more, but the bulk of the script and logic has been implemented and users can thus query information from most, if not all lines. Some bugs/edge cases may be present 
that have not been checked off yet.
